---
title: "Architecture — Design & Extension Points"
description: "High-level architecture of langchain-adk: request lifecycle, design decisions, custom session backends, custom planners, and extension points."
keywords: ["architecture", "design", "extension points", "custom session", "custom planner", "request lifecycle"]
---
