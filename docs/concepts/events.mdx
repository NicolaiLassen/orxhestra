---
title: "Events"
description: "Every agent yields a stream of unified Event objects distinguished by EventType. Learn about event types, convenience properties, metadata, and EventActions."
---
