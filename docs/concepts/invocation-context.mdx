---
title: "Context"
description: "Context is the runtime state passed through every agent in the call tree, carrying session binding, mutable shared state, run config, and event callbacks."
---
