---
title: "Context — Runtime State & Agent Communication"
description: "Context carries session binding, shared state, run config, and event callbacks through the agent tree. Supports derived contexts and ReadonlyContext."
keywords: ["Context", "invocation context", "agent state", "ReadonlyContext", "CallbackContext"]
---
