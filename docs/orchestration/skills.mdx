---
title: "Skills — Dynamic Instruction Loading"
description: "Reusable instruction blocks agents can discover and load at runtime. InMemorySkillStore with list_skills and load_skill tools."
keywords: ["skills", "InMemorySkillStore", "dynamic instructions", "skill store", "agent skills"]
---
