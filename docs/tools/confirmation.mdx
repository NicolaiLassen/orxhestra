---
title: "Tool Confirmation — Human Approval for Dangerous Actions"
description: "Gate dangerous tool executions with ToolContext.request_confirmation(). Pause and require approval before delete, drop, or other risky operations."
