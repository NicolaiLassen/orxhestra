---
title: "Tools — Function, Agent, Transfer & MCP Tools"
description: "Function tools, AgentTool sub-agents, transfer handoffs, exit loop, long-running tools, MCP adapters, and ToolContext for stateful tools."
keywords: ["tools", "function tool", "AgentTool", "transfer tool", "MCP", "tool calling", "ToolContext"]
---
