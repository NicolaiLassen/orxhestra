...
from langchain_adk.composer.builders.tools import (
    import_object,
    resolve_agent_tool,
    resolve_builtin,
    resolve_function,
...
class Composer:
    ...
    Uses the builder registry (``langchain_adk.composer.builders``) to
    ...
    def _load_spec(path: str | Path) -> ComposeSpec:
        ...
        try:
            ...
            msg = "PyYAML is required: pip install langchain-adk[composer]"
    ...
    async def _build_agent(self, name: str) -> BaseAgent:
        ...
        from langchain_adk.composer.builders.agents import Helpers, get
    ...
    def _build_session_service(name: str) -> BaseSessionService:
        ...
        if name == "memory":
            from langchain_adk.sessions.in_memory_session_service import (
